/*
 * Overwrite some ceres class to support quaternion parameterization
 */

#ifndef SRC_CORE_EIGENQUATERNIONPARAMETERIZATION_H_
#define SRC_CORE_EIGENQUATERNIONPARAMETERIZATION_H_
...
#endif /* SRC_CORE_EIGENQUATERNIONPARAMETERIZATION_H_ */
