  ...
  XMLElement* save(MapSerializationHelper& helper)
    {
  	  ...
  	  camera->SetAttribute("mgvvCameraParams",helper.saveVector(mgvvCameraParams).c_str());
    ...
    void load(const XMLElement* camera, MapSerializationHelper& helper)
    {
  	  ...
  	  mgvvCameraParams = helper.loadVector<NUMTRACKERCAMPARAMETERS>(string(camera->FindAttribute("mgvvCameraParams")->Value()));
