...
struct MapPoint
{
  ...
  Vector<3> v3Normal_NC;             // Unit vector in Source-KF coords indicating patch normal (always (0,0,-1))
  ...
  //XMLElement* save(MapSerializationHelper& helper, int mpid);
